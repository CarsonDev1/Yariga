const Search = () => {
	return (
		<div className='flex items-center pb-[25px] gap-[20px]'>
			<div className='flex pt-[18px] pb-[15px] pl-[10px] pr-[10px] bg-[#F7F7F7] gap-1 w-[20%] rounded-lg'>
			...
			<div className='pt-[10px] pb-[12px] pl-[10px] pr-[10px] bg-[#F7F7F7] w-[15%] rounded-lg'>
				<select
					name=''
					id=''
			...
			<div className='pt-[10px] pb-[12px] pl-[10px] pr-[10px] bg-[#F7F7F7] w-[15%] rounded-lg'>
				<select name='' id='' className='pr-14 bg-transparent outline-none text-xs font-medium text-[#808191]'>
			...
			<div className='flex items-center gap-[10px] text-xs font-medium pt-[10px] pb-[12px] pl-[10px] pr-[10px] bg-[#F7F7F7] w-[8%] rounded-lg'>
